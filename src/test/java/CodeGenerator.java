...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dataSourceConfig
                .setUrl("jdbc:mysql://localhost:3306/glorious-youth?allowPublicKeyRetrieval=true&useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=Asia/Shanghai")
                .setDriverName("com.mysql.cj.jdbc.Driver")
                .setUsername("root")
                .setPassword("a752245683");
